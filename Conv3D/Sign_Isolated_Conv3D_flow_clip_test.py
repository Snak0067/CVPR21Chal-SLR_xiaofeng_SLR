...
from models.Conv3D import flow_r2plus1d_18
...
# Path setting
exp_name = 'color_flow_final_test'
data_path = "../data/train_flow_color_2"
data_path2 = "../data/test_flow_color_2"
...
weight_decay = 1e-4 #1e-4 train, 0 finetune
log_interval = 80
sample_size = 128
sample_duration = 32
attention = False
...
if __name__ == '__main__':
    ...
    # load pretrained
    checkpoint = torch.load('final_models_finetuned/flow_color_final_finetuned.pth')
